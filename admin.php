...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="navbar navbar-fixed-top navbar-inverse inverse" style="background-color:#ADD8E6; height:80px">


					<a href="#" class="navbar-brand"><img src="images/logo3.png" style="height: 60px; width:80px; margin-left:50px;">
	...
	<a href="tambah_admin.php">&nbsp;
		<div class="btn btn-info">Tambah Data</div>
	</a>
